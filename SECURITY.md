...
- **GitHub Security Advisories**: [Report here](https://github.com/Avinashvelu03/TypeForge-ts/security/advisories/new)
...
- Always pin to a specific version in production: `"typeforge-ts": "1.0.6"`
